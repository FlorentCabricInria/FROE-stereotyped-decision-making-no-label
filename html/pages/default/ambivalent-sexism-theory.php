...
<div id="row">
    ...
    <p> To end this study, we will ask you to answer 12 questions. These 12 questions have been introduced by social
        psychologists and have been widely used by scientists. </p>
    <p style="font-size: 1em"><strong>Instructions:</strong> For each statement, indicate whether you "Strongly
        Disagree", "Somewhat Disagree", Slightly Disagree",
