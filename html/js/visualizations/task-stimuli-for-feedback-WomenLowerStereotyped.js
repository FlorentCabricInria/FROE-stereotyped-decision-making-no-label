/* eslint-disable */  let posX = [233.851298 , 220 , 236.9879487 , 204.5869 , 261.7787621 , 255 , 290 , 200 , 230 , 288.6149646 ,
...
d3.csv('./html/js/visualizations/c.csv').then((data) => {
  ...
  const svg = d3.select('#final-decision-feedback-chart-WomenLowerStereotyped')
    .attr('width', width)
    .attr('height', height)
