...
createSteoreotypedVisualization2WLNS()
...
function createSteoreotypedVisualization2WLNS(){
  ...
  d3.csv('./html/js/visualizations/women-lower-v2.csv').then((data) => {
    ...
    const svg = d3.select('#TrainingTaskChart2WomenLowerNonStereotypedTraining1')
      .attr('width', width)
      .attr('height', height)
